...
func TestStandard(t *testing.T) {
	...
	want := map[string]string{
		...
		"app.kubernetes.io/managed-by": "addons-operator",
...
func TestStandard_FixedLabels(t *testing.T) {
	...
	if got[labels.ManagedBy] != "addons-operator" {
		t.Errorf("Standard() ManagedBy = %q, want %q", got[labels.ManagedBy], "addons-operator")
	}
}
